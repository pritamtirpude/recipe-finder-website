  ...
  return (
    <footer className="overflow-hidden px-4 md:px-8 lg:mx-auto lg:max-w-[1440px] lg:px-0 lg:max-2xl:px-8">
      <div className="relative z-50 flex flex-col items-center justify-center overflow-hidden rounded-2xl bg-neutral-200 py-12 md:py-20 lg:py-24">
        <div className="absolute -z-10 hidden size-full bg-[url(/assets/images/pattern-fork.svg)] bg-contain bg-left bg-no-repeat md:top-48 md:-left-10 md:size-[180px] lg:top-6 lg:-left-12 lg:block lg:size-full lg:max-2xl:top-48 lg:max-2xl:-left-10 lg:max-2xl:size-[180px]" />
        ...
        <div className="absolute -z-10 hidden size-full bg-[url(/assets/images/pattern-knife.svg)] bg-contain bg-right bg-no-repeat md:-top-10 md:right-0 md:size-[170px] lg:top-0 lg:-right-14 lg:block lg:size-full lg:max-2xl:-top-10 lg:max-2xl:right-0 lg:max-2xl:size-[170px]" />
      </div>
